...
export default function JobCardsIntroScreen() {
  return (
      ...
      <ScrollView className="flex-1" contentContainerClassName="flex-1 px-6 py-8">
        ...
        >
          ...
          <Text className="text-base text-gray-600 dark:text-gray-400 text-center leading-6">
            View all your assigned job cards, filter by status, and search for specific jobs. Accept or decline new assignments, and track your progress in real-time.
          </Text>
        </Animated.View>
